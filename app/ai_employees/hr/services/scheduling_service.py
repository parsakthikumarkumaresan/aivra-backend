...
class SchedulingService:
    ...
    async def request_interview(self, organization_id: str, candidate_id: str) -> Interview:
        return await self.interview_repo.add(
            Interview(
    ...
    async def book_slot(
        self, organization_id: str, slot_id: str, candidate_id: str, *, job_title: str
    ) -> Interview:
        ...
        meeting_link = await self._try_create_calendar_event(
            organization_id, slot, candidate, job_title
        )
    ...
    async def _try_create_calendar_event(
        self, organization_id: str, slot: ScheduleSlot, candidate: Candidate, job_title: str
    ) -> str | None:
